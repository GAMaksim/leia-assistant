export class SpeechHandler {
    ...
    speak(text) {
        ...
        utterance.rate = 1.0;
        utterance.pitch = 1.1; // Slightly higher pitch for LEIE
        ...
        utterance.onstart = () => {
            ...
            if (window.leieApp?. emotionController) {
                window.leieApp.emotionController.startLipSync();
            }
        };
        ...
        utterance. onend = () => {
            ...
            if (window.leieApp?. emotionController) {
                window.leieApp.emotionController.stopLipSync();
            }
        };
